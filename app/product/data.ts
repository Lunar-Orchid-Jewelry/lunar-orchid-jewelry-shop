...
export const products: Record<string, ProductItem> = {
  "cosmic-oasis": {
    slug: "sterling-silver-bello-opal-pendant",
    title: "Cosmic Oasis",
    description: "",
    paragraphs: [
    ...
    coverImage: "/images/cosmic-oasis.webp",
  ...
  "amethyst-whisper": {
    ...
    coverImage: "/images/amethyst-whisper-slide-1-674x506.webp",
  ...
  "ancient-copper": {
    ...
    coverImage: "/images/ancient-copper-icon.webp",
    coverImageAlt: "Ancient Copper Ring",
    productLink: "",
    price: "$PRICE",
    materials: "Copper",
    carouselSlides: [
  ...
  "copper-amethyst-cuff": {
    ...
    coverImage: "/images/copper-amethyst-cuff.webp",
    coverImageAlt: "Copper Amethyst Cuff",
    productLink: "",
    price: "$PRICE",
    materials: "Copper, Amethyst",
    carouselSlides: [
  ...
  "copper-breath": {
    ...
    coverImage: "/images/copper-breath.webp",
  ...
  "copper-breeze": {
    ...
    coverImage: "/images/copper-breeze-icon.webp",
    coverImageAlt: "Copper Breeze Earrings",
    productLink: "",
    price: "$PRICE",
  ...
  "copper-rose-ring": {
    ...
    coverImage: "/images/copper-rose-ring.webp",
  ...
  "copper-spiral-ring": {
    ...
    coverImage: "/images/copper-spiral-ring.webp",
  ...
  "dragon-slayer": {
    ...
    coverImage: "/images/dragon-slayer-1.webp",
    coverImageAlt: "Dragon Slayer Pendant",
    productLink: "",
    price: "$PRICE",
    materials: "Copper",
    carouselSlides: [
  ...
  "forest-pearl": {
    ...
    coverImage: "/images/forest-pearl-icon.webp",
    coverImageAlt: "Forest Pearl Necklace",
    productLink: "",
    price: "$PRICE",
  ...
  "necklace-1": {
    ...
    paragraphs: [],
    coverImage: "/images/forest-pearl-icon.webp",
    coverImageAlt: "Sterling Silver Bello Opal Necklace Pendant",
    productLink: "product/cosmic-oasis",
    price: "$PRICE",
    materials: "",
    carouselSlides: [],
  ...
  "necklace-2": {
    ...
    description: "",
    paragraphs: [],
    coverImage: "/images/sacred-alignment-icon.webp",
    coverImageAlt: "",
    productLink: "",
    price: "$PRICE",
    materials: "",
  ...
  "necklace-3": {
    ...
    description: "",
    paragraphs: [],
    coverImage: "/images/cosmic-oasis-3.webp",
    coverImageAlt: "",
    productLink: "",
    price: "$PRICE",
    materials: "",
  ...
  "necklace-4": {
    ...
    description: "",
    paragraphs: [],
    coverImage: "/images/faire-magic-icon.webp",
    coverImageAlt: "",
    productLink: "",
    price: "$PRICE",
    materials: "",
  ...
  "bracelet-1": {
    ...
    description: "",
    paragraphs: [],
    coverImage: "/images/photoroom-20260116.webp",
    coverImageAlt: "",
    productLink: "",
    price: "$PRICE",
    materials: "",
  ...
  "bracelet-2": {
    ...
    description: "",
    paragraphs: [],
    coverImage: "/images/copper-amethyst-cuff-copy.webp",
    coverImageAlt: "",
    productLink: "",
    price: "$PRICE",
    materials: "",
  ...
  "bracelet-3": {
    ...
    description: "",
    paragraphs: [],
    coverImage: "/images/photoroom-20260129.webp",
    coverImageAlt: "",
    productLink: "",
    price: "$PRICE",
    materials: "",
  ...
  "bracelet-4": {
    ...
    description: "",
    paragraphs: [],
    coverImage: "/images/orange-agate-copper-cuff.webp",
    coverImageAlt: "",
    productLink: "",
    price: "$PRICE",
    materials: "",
