...
export const necklaces: Record<string, ProductItem> = {
  "cosmic-oasis": {
    title: "Cosmic Oasis",
    description: "",
    paragraphs: [
...
export const bracelets: Record<string, ProductItem> = {
  //
};

export const rings: Record<string, ProductItem> = {
  //
};

const products = { ...necklaces, ...bracelets, ...rings };
