      ...
      <div className="bg-white font-josefin text-gray-800">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 py-12 lg:py-20">
              ...
              <div className="w-full lg:w-[65%] text-center lg:text-left">
                <h1 className="font-cinzel text-4xl sm:text-5xl lg:text-6xl xl:text-7xl text-dark mb-6">
                  Lunar Orchid Jewelry
                </h1>
                <h3 className="font-bad-script text-xl sm:text-2xl text-gray-600 mb-4 leading-relaxed">
                  <p>Earthly Inspired</p>
                  <p>Hand Made</p>
                  <p>Uniquely Imperfect</p>
                </h3>
                <h4 className="font-bad-script text-base sm:text-lg text-gray-500 mb-8 leading-relaxed">
                  <p>Float among the mystical and the magical</p>
                </h4>
                <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                  <a href="#" className="inline-block bg-primary text-white px-8 py-3 font-josefin text-base hover:bg-primary-hover transition-colors rounded-sm">
                    Shop by Product
                  </a>
                  <a href="#" className="inline-block bg-primary text-white px-8 py-3 font-josefin text-base hover:bg-primary-hover transition-colors rounded-sm">
                    Shop by Collection
        ...
        <section className="bg-white py-12 lg:py-16">
              ...
              {[
                ...
                <div key={i} className="rounded-b-md hover:shadow-lg hover:scale-105 transition">
                  <a href="bello-opal-sterling-silver-galaxy-pendant.html" className="block">
                    ...
                    <h4 className="text-secondary text-base font-josefin text-center mb-1">{item.name}</h4>
                    <p className="text-dark text-lg font-josefin text-center">{item.price}</p>
                  </a>
                </div>
              ))}
            </div>
          ...
          <div className="text-center mt-8">
            <a href="gallery.html" className="inline-block bg-primary text-white px-6 py-2 font-josefin text-sm hover:bg-primary-hover transition-colors rounded-sm">
              More Necklaces
            </a>
          </div>
        </section>
              ...
              {[
                ...
                <div key={i} className="rounded-b-md hover:shadow-lg hover:scale-105 transition">
                  <a href="bello-opal-sterling-silver-galaxy-pendant.html" className="block">
                    ...
                    <h4 className="text-secondary text-base font-josefin text-center mb-1">Cosmic Oasis</h4>
                    <p className="text-dark text-lg font-josefin text-center">$PRICE</p>
                  </a>
                </div>
              ))}
            </div>
              ...
              {[
                ...
                <div key={i} className="rounded-b-md hover:shadow-lg hover:scale-105 transition">
                  <a href="rose-gold-ammonite-fossil-pendant.html" className="block">
                    ...
                    <h4 className="text-primary text-base font-josefin text-center mb-1">{item.name}</h4>
                    <p className="text-gray-500 text-sm font-josefin text-center mb-1">{item.desc}</p>
                    <p className="text-dark text-lg font-josefin text-center">{item.price}</p>
                  </a>
                </div>
              ))}
              ...
              {[
                ...
                <div key={i} className="rounded-b-md hover:shadow-lg hover:scale-105 transition">
                  <a href="shop-all-rings.html" className="block">
                    ...
                    <h4 className="text-base font-josefin text-center mb-1">{item.name}</h4>
                    <p className="text-dark text-lg font-josefin text-center">coming soon</p>
                  </a>
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-col lg:flex-row-reverse gap-12 items-center">
              ...
              <div className="w-full lg:w-1/2">
                ...
                <div className="text-gray-300 font-josefin leading-relaxed">
                  <p className="mb-4">I'm the creative behind Lunar Orchid Jewelry!</p>
                  <p className="mb-4">I developed a love of making jewelry in my childhood. My great-grandmother was an artist, jeweler, and collector of stones, shells, and trinkets of the earth. She taught me the basic skills of jewelry crafting, which I continued to foster after she passed.</p>
                  <p>When I'm not making jewelry, I'm probably doing something ridiculous and you shouldn't ask too many questions.</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="w-full lg:w-1/2 text-center lg:text-left">
                  <div className="border border-dark rounded-sm p-8">
                    <p className="text-lg font-josefin mb-6">
                      <a href="donation.html" className="text-dark hover:text-primary transition-colors font-medium">Donate HERE!</a>
                    </p>
                    <p className="text-gray-600 font-josefin leading-relaxed">
                      Click to send head scratches to Jack<br />
                      <em>- His Majesty Mr. Snoot -</em><br />
                      Who single pawedly keeps Lunar Orchid Jewelry running smoothly
                    </p>
                  </div>
                </div>
                <div className="w-full lg:w-1/2">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-xl mx-auto">
              <div className="text-center mb-8">
                <h3 className="font-cinzel text-2xl sm:text-3xl text-dark mb-4">Contact Me!</h3>
                <p className="text-gray-600 font-josefin leading-relaxed">
                  Please reach out with any questions!<br /><br />
                  <em>*Site in Construction*</em><br />
                  If you notice a broken link please let me know!
                </p>
              </div>
              <form action="https://mobirise.eu/" method="POST" className="space-y-4">
                <input type="hidden" name="email" data-form-email="true" value="RsFgMPN/DMAPLjBmTFh5r1Kao99mgjskMK0PQycW5kq0M5E+1k1eOJbRQ+2tfLVp4IE2zLqmfzOXjmrlNk2NjRXzsH3wzWPbfqyDEhDKM9Tg6xWbC53V+zNPl1W4OAZc.uuHL9Ohemqev86tiEfkMxT36HukH4Qx7gV3WnOiPGjOxY6SpAMM+C4nGZrt+ZoLorX6WBk0jWXwoqQ+1MK+Rid7xVmwXHNd3q5O43nEqyDBFWfJrxkbVkGu+T8WQcmLC" />
                <div className="hidden bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-sm" role="alert">
                  Thanks for reaching out. I'll be in touch soon!
                </div>
                <div className="hidden bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-sm" role="alert">
                  Oops...! some problem!
                </div>
                <div>
        ...
        <section className="bg-white py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <h3 className="font-cinzel text-2xl sm:text-3xl lg:text-4xl text-dark mb-6">OUR SERVICES</h3>
            ...
            <div className="flex flex-col lg:flex-row gap-12 justify-center">
              {[
                ...
                <div key={i} className="w-full lg:w-[33%] text-center">
                  ...
                  <div className="mt-6">
                    <p className="text-gray-500 font-josefin text-sm mb-1">{item.date}</p>
                    <h5 className="font-josefin text-base sm:text-lg text-dark mb-2">{item.title}</h5>
                    <h5 className="font-josefin text-sm text-gray-500">{item.author}</h5>
                  </div>
                </div>
              ))}
            </div>
